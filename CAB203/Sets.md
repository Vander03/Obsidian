...
NoteL you can define set unions with points 4 and 3, where point 3 defines a set large enough to hold all the terms, and point 3 filters any term that is not in the union
