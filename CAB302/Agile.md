...
### Sprint 
A sprint is a fixed stretch of time, usually less than a month, in which the team works towards a given objective (the sprint goal). Activities carried out during a sprint include:
