...
### [Use appropriate headings and units to present information]
...
### [Use consistent output formats (e.g. money as 2 decimal places)]
...
### [Report when each of the functionality is in progress, completed, or failed, along with any messages or errors]
...
### [Allow or not allow users to interact with a widget under some circumstances]
